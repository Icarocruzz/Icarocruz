...
export const ABOUT_CONTENT = {
    paragraphs: [
        "Sou um desenvolvedor front-end apaixonado por tecnologia e inovação, com vasto estudo e experiência prática na criação de aplicações web modernas e responsivas. Meu foco é construir interfaces funcionais e visualmente atraentes que proporcionam excelentes experiências aos usuários.",
